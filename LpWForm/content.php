...
<div class="top-content"> 
  ...
  <nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
    <div class="container">
      <div class="navbar-header"> <a class="navbar-brand" href="index.php"> <img src="assets/img/logoDryWall.svg" class="logo" alt="logo"> </a> <a href="index.php" class="logo-text">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text">
          <h1 class="wow fadeInLeftBig"> <strong>DryWall </strong>– Right and Finished Fast.</h1>
          <div class="description wow fadeInLeftBig">
            <p> At DryWall Commissioner, we've worked with everyone in Montreal from individual home owners to contractors to large-scale commercial operations for simple and complex drywall services. With every job we do, another customer is satisfied and added to our list of local successes. </p>
          </div>
    ...
    <div class="row">
      <div class="col-sm-12 about section-description wow fadeIn">
        ...
        <div class="divider-1 wow fadeInUp"><span></span></div>
         <h3 class="about-subheader">A one-stop shop for an impressive selection of drywall services.</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
       <p class="about-us"> It may seem like all drywall service firms are the same, but the difference between DryWall Commissioner and the rest of the pack can be startling. Focused on quality, customer service, and providing a peerless ability, we value a job well done more than just quick, in-and-out work. </p>
        <p class="about-us"> Because drywall plays such a vital role in your Montreal property's appearance, you should trusty your service provider to be of the highest caliber. At DryWall Commissioner, we aim for exactly that and our previous work stands as a testament to our commitment to quality. </p>
        <p class="about-us">Call DryWall Commissioner at 800-890-9432 for a list of past drywall projects in Montreal or to arrange a free consultation.</p> 
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 more-features section-description wow fadeIn">
        <h2>Our Services</h2>
        <div class="divider-1 wow fadeInUp"><span></span></div>
        <h3 class="service-subheader"> <strong>Full Suit </strong>of Drywall Services</h3>
        <p>Whether you need drywall for a new construction or just need an affordable fix for water damage, DryWall Commissioner has you covered. Check out our service areas to the below.</p>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="lightboxgallery-gallery clearfix">
         ...
         <a class="lightboxgallery-gallery-item" target="_blank" href="assets/img/gallery/service1.jpg" data-title="Aidan Meyer" data-alt="Aidan Meyer" data-desc="">
          <div> <img src="assets/img/gallery/service1_thumb.jpg" title="Drywall Installation" alt="Drywall Installation">
            <div class="lightboxgallery-gallery-item-content"> <span class="lightboxgallery-gallery-item-title">Drywall Installation</span> </div>
          </div>
          </a>
          
          
          
           <a class="lightboxgallery-gallery-item" target="_blank" href="assets/img/gallery/service2.jpg" data-title="DRYWALL REPAIRS" data-alt="Aidan Meyer" data-desc="">
          <div> <img src="assets/img/gallery/service2_thumb.jpg" title="DRYWALL REPAIRS" alt="DRYWALL REPAIRS">
            <div class="lightboxgallery-gallery-item-content"> <span class="lightboxgallery-gallery-item-title">DRYWALL REPAIRS</span> </div>
          </div>
          </a> <a class="lightboxgallery-gallery-item" target="_blank" href="assets/img/gallery/service3.jpg" data-title="DRYWALL INSULATION" data-alt="Aidan Meyer" data-desc="">
          <div> <img src="assets/img/gallery/service3_thumb.jpg" title="DRYWALL INSULATION" alt="DRYWALL INSULATION">
            <div class="lightboxgallery-gallery-item-content"> <span class="lightboxgallery-gallery-item-title">DRYWALL INSULATION</span> </div>
          </div>
          </a> <a class="lightboxgallery-gallery-item" target="_blank" href="assets/img/gallery/service4.jpg" data-title="PLASTER AND STUCCO" data-alt="Aidan Meyer" data-desc="">
          <div> <img src="assets/img/gallery/service4_thumb.jpg" title="PLASTER AND STUCCO" alt="PLASTER AND STUCCO">
            <div class="lightboxgallery-gallery-item-content"> <span class="lightboxgallery-gallery-item-title">PLASTER AND STUCCO</span> </div>
          </div>
          </a> <a class="lightboxgallery-gallery-item" target="_blank" href="assets/img/gallery/service5.jpg" data-title="Trim and Molding " data-alt="Aidan Meyer" data-desc="">
          <div> <img src="assets/img/gallery/service5_thumb.jpg" title=" Trim and Molding" alt="Trim and Molding">
            <div class="lightboxgallery-gallery-item-content"> <span class="lightboxgallery-gallery-item-title"> Trim and Molding </span> </div>
          </div>
          </a> </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 call-to-action section-description wow fadeInLeftBig">
        ...
        <p class="cta-desc">Don't Settle For A Shoddy Drywall Job. Call us And Get The Service You Deserve.</p>
        </div>
      </div>
    </div>
    <div class="row">
...
<div class="section-container after-cta wh-container">
  <div class="container">
   ...
   <h3> Work Hours </h3>
          ...
          <div class="wh-desc">
            <h5> MON-FRI 8:00am-6:00pm</h5>
            <h5>Sat 8:00am-4:00pm</h5>
            <h5>Sun By Appointment</h5>
          </div>
        </div>
      </div>
    </div>
