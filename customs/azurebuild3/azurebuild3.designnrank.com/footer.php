...
*/
 $('.form-inner-box').css("background-color", '<?php echo $backgroud_color; ?>');
 $('.divider-1 span').css("background-color", '<?php echo $backgroud_color; ?>');
 $('.btn-link-2').css("background-color", '<?php echo $backgroud_color; ?>');
 $('.services .panel-primary > .panel-heading').css("background-color", '<?php echo $backgroud_color; ?>');
